...
export const fr: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Chromatique repéré le {date}",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Préparez les souvenirs fiables issus de sessions d'agent antérieures. Le rêve promeut les plus utiles vers la mémoire à long terme.",
      dateRange: "Plage de dates des sessions",
      dateRangeHint: "Laissez l'une des dates vide pour analyser toute la plage disponible.",
      from: "Du",
      to: "Au",
      actions: "Remplir rétroactivement",
      preview: "Aperçu",
      ...
      previewTruncated:
        "Cet aperçu affiche le premier lot limité. L'application continue avec les candidats restants.",
      candidateCount: "{count} candidats",
      noCandidates: "Aucun nouveau candidat de session de confiance n'a été trouvé.",
      progress: "{days} jours traités · {staged} en attente",
      ...
      complete: "{count} en attente ; la promotion se fait via le rêve",
      rollbackConfirmTitle: "Annuler le remplissage des sessions ?",
      rollbackConfirmDescription:
        "Supprimer les entrées de journal et les souvenirs en attente créés par le remplissage des sessions pour cet agent.",
      rollbackWarning:
        "Les curseurs de session suivis restent en place, de sorte que les entrées supprimées ne seront pas remises en attente.",
      rollbackComplete: "Remplissage des sessions annulé",
      rollbackCounts: "{diary} entrées de journal et {staged} entrées en attente supprimées",
  ...
  talkPage: {
    intro:
      "Configurez les fournisseurs de voix en temps réel, les modèles et les voix des intervenants.",
    voiceSection: {
    ...
    provider: {
      title: "Fournisseur",
      description: "Auto sélectionne le premier fournisseur avec des identifiants fonctionnels.",
      auto: "Automatique",
    },
    model: {
      title: "Modèle",
      description: "Modèle vocal en temps réel pour les sessions Talk du navigateur.",
    ...
    voice: {
      ...
      description:
        "Voix utilisée pour les réponses parlées. GPT-Live verrouille la voix une fois l'appel commencé.",
      default: "Valeur par défaut du fournisseur",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live fonctionne avec un abonnement ChatGPT : connectez-vous une fois avec « openclaw models auth login --provider openai ». Aucune clé API Platform requise. Talk du navigateur uniquement. Le travail délégué peut être orienté pendant son exécution et nécessite une confirmation vocale exacte pour les actions à fort impact.",
      ready: "Prêt",
    },
  },
  memoryPage: {
    ...
    memories: {
      ...
      searching: "Recherche des souvenirs…",
  ...
  chat: {
    ...
    composer: {
      ...
      fallbackCleared: "Repli supprimé : {model}",
      fallbackSelected: "Sélectionné : {model}",
      fallbackCurrent: "Actif : {model}",
      fallbackPrevious: "Solution de repli précédente : {model}",
