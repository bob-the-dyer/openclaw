...
export const vi: TranslationMap = {
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Chuẩn bị các bộ nhớ đáng tin cậy từ các phiên agent trước đó. Chế độ mơ sẽ đưa những bộ nhớ hữu ích vào bộ nhớ dài hạn.",
      dateRange: "Khoảng ngày của phiên",
      dateRangeHint: "Để trống một trong hai ngày để quét toàn bộ phạm vi khả dụng.",
      from: "Từ",
      to: "Đến",
      actions: "Điền lại",
      preview: "Xem trước",
      ...
      previewTruncated:
        "Bản xem trước này hiển thị lô giới hạn đầu tiên. Áp dụng sẽ tiếp tục qua các ứng viên còn lại.",
      candidateCount: "{count} ứng viên",
      noCandidates: "Không tìm thấy phiên ứng viên đáng tin cậy mới nào.",
      progress: "Đã xử lý {days} ngày · {staged} đã sắp xếp",
      processedCandidates: "Đã xử lý {count} phiên ứng viên",
      processedDayCountOne: "Đã xử lý {count} ngày",
      processedDayCount: "Đã xử lý {count} ngày",
      complete: "{count} đã sắp xếp; việc thăng cấp diễn ra qua dreaming",
      rollbackConfirmTitle: "Hoàn tác lấp đầy phiên?",
      rollbackConfirmDescription:
        "Xóa các mục nhật ký và bộ nhớ đã sắp xếp được tạo bởi việc lấp đầy phiên cho tác nhân này.",
      rollbackWarning:
        "Các con trỏ phiên đã theo dõi vẫn giữ nguyên, vì vậy các mục đã xóa sẽ không được sắp xếp lại.",
      rollbackComplete: "Đã hoàn tác việc lấp đầy phiên",
      rollbackCounts: "Đã xóa {diary} mục nhật ký và {staged} mục đã sắp xếp",
      unavailable: "Việc lấp đầy phiên không khả dụng trên Gateway này.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      ...
      resize: "Thay đổi kích thước Ask OpenClaw",
      dockBottom: "Gắn Ask OpenClaw ở dưới cùng",
      dockRight: "Gắn Ask OpenClaw ở bên phải",
    },
    history: {
      button: "Lịch sử",
  ...
  talkPage: {
    intro:
      "Cấu hình các nhà cung cấp giọng nói thời gian thực, mô hình và giọng nói của người nói.",
    voiceSection: {
      title: "Giọng nói thời gian thực",
      description:
        "Cuộc trò chuyện bằng giọng nói liên tục với agent của bạn. Các bộ chọn bên dưới ghi vào cài đặt talk.realtime; biểu mẫu đầy đủ bên dưới bao quát mọi thứ khác.",
    },
    status: {
      title: "Trạng thái",
      ready: "Sẵn sàng",
      ...
      unavailable: "Không khả dụng",
      unavailableHint: "Kết nối với Gateway để kiểm tra khả năng sẵn sàng của giọng nói realtime.",
      activeProvider: "Nhà cung cấp đang hoạt động: {provider}",
      noProvider: "Chưa có nhà cung cấp giọng nói realtime nào được cấu hình.",
    },
    provider: {
      title: "Nhà cung cấp",
    ...
    model: {
      title: "Mô hình",
      description: "Mô hình giọng nói realtime cho phiên Talk trên trình duyệt.",
    ...
    voice: {
      ...
      description:
        "Giọng được dùng cho các phản hồi nói. GPT-Live khóa giọng nói khi cuộc gọi bắt đầu.",
      default: "Mặc định của nhà cung cấp",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live hoạt động với gói đăng ký ChatGPT: đăng nhập một lần bằng “openclaw models auth login --provider openai”. Không cần khóa Platform API. Chỉ dành cho Talk trên trình duyệt. Công việc được ủy quyền có thể được điều khiển trong khi chạy và yêu cầu xác nhận bằng giọng nói chính xác đối với các hành động có tác động lớn.",
      ready: "Sẵn sàng",
    },
  },
  memoryPage: {
    intro: "Chọn cách OpenClaw lưu trữ, tìm kiếm và duy trì bộ nhớ của agent.",
    ...
    overview: {
      hero: {
        ...
        needsAttention: "Bộ nhớ cần chú ý",
        ...
        gatewayOffline: "Gateway đang ngoại tuyến, nên không có trạng thái bộ nhớ.",
        hybridSearch: "tìm kiếm kết hợp",
        keywordSearch: "tìm kiếm từ khóa (không nhúng)",
      ...
      schedule: {
        title: "Lịch ngủ",
        nextRun: "kế tiếp {time}",
        lastRun: "gần nhất {time}",
        notScheduled: "Chưa lên lịch",
      },
      activity: {
        title: "Hoạt động",
        promotedToday: "Đã đề bạt hôm nay",
        promotedTotal: "Tổng số đã đề bạt",
        shortTermCount: "Mục ngắn hạn đang chờ",
        phaseHitCount: "Tín hiệu pha",
        lightPhaseHitCount: "Lượt pha nhẹ",
        remPhaseHitCount: "Lượt pha REM",
      },
      health: {
    ...
    memories: {
      ...
      idle: "Tìm kiếm một người, dự án, quyết định, hoặc bất cứ điều gì mà agent này ghi nhớ.",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Cường độ token hằng ngày cho khoảng thời gian đã chọn, tối đa một năm.",
  ...
  chat: {
    ...
    messages: {
      ...
      askInSideChat: "Hỏi trong cuộc trò chuyện phụ",
      rewind: "Tua lại",
    ...
    composer: {
      ...
      contextCompacted: "Ngữ cảnh đã được nén",
  ...
  cron: {
    adminRequired: "Chỉ duyệt xem. Thay đổi tự động hóa yêu cầu quyền truy cập operator.admin.",
    tabs: {
