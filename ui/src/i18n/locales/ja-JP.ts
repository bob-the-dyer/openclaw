...
export const ja_JP: TranslationMap = {
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      previewTruncated:
        "このプレビューは最初の制限付きバッチを表示しています。適用すると残りの候補も処理を続行します。",
      candidateCount: "{count} 件の候補",
      noCandidates: "新しい信頼済みセッション候補は見つかりませんでした。",
      progress: "{days} 日を処理済み · {staged} 件をステージング",
      processedCandidates: "{count} 件のセッション候補を処理しました",
      processedDayCountOne: "{count} 日を処理しました",
      processedDayCount: "{count} 日を処理しました",
      complete: "{count} 件をステージング。昇格はドリーミングで行われます",
      rollbackConfirmTitle: "セッションバックフィルをロールバックしますか？",
      rollbackConfirmDescription:
        "このエージェントのセッションバックフィルで作成された日記エントリとステージング済みのメモリを削除します。",
      rollbackWarning:
        "追跡中のセッションカーソルはそのまま維持されるため、削除されたエントリが再度ステージングされることはありません。",
      rollbackComplete: "セッションバックフィルをロールバックしました",
      rollbackCounts: "日記エントリ {diary} 件とステージング済みエントリ {staged} 件を削除しました",
      unavailable: "このGatewayではセッションバックフィルは利用できません。",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  talkPage: {
    intro: "リアルタイム音声プロバイダー、モデル、スピーカーボイスを設定します。",
    voiceSection: {
      title: "リアルタイム音声",
      description:
    ...
    status: {
      ...
      notReady: "未設定",
      unavailable: "利用不可",
      unavailableHint: "Gateway に接続して、リアルタイム音声の準備状況を確認してください。",
      activeProvider: "アクティブなプロバイダー: {provider}",
      noProvider: "リアルタイム音声プロバイダーはまだ設定されていません。",
    },
    provider: {
      title: "プロバイダー",
      description: "Auto は有効な資格情報を持つ最初のプロバイダーを選択します。",
      auto: "自動",
    },
    model: {
      title: "モデル",
      description: "ブラウザ Talk セッション用のリアルタイム音声モデル。",
      default: "プロバイダーのデフォルト",
      defaultNamed: "デフォルト ({model})",
    },
    voice: {
      title: "スピーカーの音声",
      description: "音声応答に使用される声。GPT-Live は通話開始後に声をロックします。",
      default: "プロバイダーのデフォルト",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live は ChatGPT のサブスクリプションで動作します。「openclaw models auth login --provider openai」で一度サインインしてください。Platform API キーは不要です。ブラウザ Talk のみ対応。委任された作業は実行中に操作でき、影響の大きいアクションには正確な音声確認が必要です。",
      ready: "準備完了",
    },
  },
  memoryPage: {
    intro: "OpenClaw がエージェントのメモリを保存、検索、管理する方法を選択します。",
    ...
    overview: {
      hero: {
        ...
        waking: "メモリを起動中…",
        hibernating: "メモリは休止中",
        needsAttention: "メモリの確認が必要です",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "このエージェントのメモリエンジンとドリームサイクルを確認しています。",
        offDescription: "設定でメモリエンジンを選択して起動します。",
        disabledDescription: "選択されたメモリエンジンは無効です。設定で再度有効にしてください。",
        gatewayOffline: "Gateway がオフラインのため、メモリのステータスを利用できません。",
      ...
      activity: {
        title: "アクティビティ",
        promotedToday: "本日昇格した数",
        promotedTotal: "昇格した合計",
        shortTermCount: "保留中の短期エントリ",
        phaseHitCount: "フェーズシグナル",
        lightPhaseHitCount: "ライトフェーズのヒット",
        remPhaseHitCount: "REMフェーズのヒット",
      },
      health: {
        title: "エンジンの状態",
        provider: "プロバイダー",
    ...
    memories: {
      searchLabel: "メモリーを検索",
      searchPlaceholder: "このエージェントのメモリーを検索",
      searchButton: "検索",
      idle: "このエージェントが記憶している人物、プロジェクト、決定事項、その他何でも検索できます。",
      searching: "メモリーを検索中…",
      results: "{count} 件の結果",
      empty: "「{query}」に一致するメモリーはありませんでした。",
      error: "メモリー検索に失敗しました: {message}",
      retry: "再試行",
      gatewayUpdateRequired: "Control UI からメモリーを検索するには Gateway を更新してください。",
      hybridSearch: "ハイブリッド検索",
  ...
  usage: {
    ...
    heatmap: {
      title: "トークンアクティビティ",
      subtitle: "選択した期間（最大1年）の日次トークン強度。",
  ...
  chat: {
    ...
    composer: {
      ...
      fallbackCleared: "フォールバックを解除: {model}",
