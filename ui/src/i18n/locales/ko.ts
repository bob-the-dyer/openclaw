...
export const ko: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ 반짝이 발견 {date}",
      lobsterdexCardCopyLink: "링크 복사",
      lobsterdexOpen: "Lobsterdex 열기",
    },
    security: {
      intro: "Gateway 접근, 도구 정책, 기기 인증, 승인을 검토하세요.",
      title: "보안",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "이전 세션에서",
      subtitle:
        "이전 에이전트 세션의 신뢰할 수 있는 메모리를 준비합니다. 드리밍이 유용한 항목을 장기 메모리로 승격합니다.",
      dateRange: "세션 날짜 범위",
      dateRangeHint: "날짜 중 하나를 비워 두면 사용 가능한 전체 범위를 스캔합니다.",
      from: "시작",
      to: "종료",
      actions: "백필",
      preview: "미리보기",
      ...
      applying: "적용 중…",
      rollback: "롤백",
      previewSummary: "{days}일에 걸쳐 후보 {candidates}개",
      previewTruncated:
      ...
      rollbackConfirmDescription:
        "이 에이전트의 세션 백필로 생성된 다이어리 항목과 준비된 메모리를 제거합니다.",
      rollbackWarning: "추적된 세션 커서는 그대로 유지되므로 제거된 항목은 다시 준비되지 않습니다.",
      rollbackComplete: "세션 백필이 롤백되었습니다",
      rollbackCounts: "다이어리 항목 {diary}개와 준비된 항목 {staged}개가 제거되었습니다",
  ...
  custodian: {
    ...
    panel: {
      ...
      dockBottom: "Ask OpenClaw를 하단에 도킹",
      dockRight: "Ask OpenClaw를 오른쪽에 도킹",
    },
    history: {
      button: "기록",
      title: "최근 변경 사항",
  ...
  mcpPage: {
    intro: "OpenClaw에 도구를 제공하는 MCP 서버를 연결하고 관리하세요.",
    ...
    setUpFirstServer: "첫 번째 MCP 서버 설정하기",
  ...
  talkPage: {
    intro: "실시간 음성 공급자, 모델, 화자 음성을 구성하세요.",
    voiceSection: {
      title: "실시간 음성",
      description:
        "에이전트와의 연속 음성 대화입니다. 아래 선택기는 talk.realtime 설정을 작성하며, 하단의 전체 양식에서 나머지 모든 항목을 다룹니다.",
    },
    status: {
      title: "상태",
      ready: "준비됨",
      ...
      activeProvider: "활성 공급자: {provider}",
      noProvider: "아직 구성된 실시간 음성 공급자가 없습니다.",
    },
    provider: {
      title: "공급자",
      description: "자동은 사용 가능한 자격 증명을 가진 첫 번째 공급자를 선택합니다.",
      auto: "자동",
    },
    model: {
      title: "모델",
    ...
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live는 ChatGPT 구독으로 작동합니다. “openclaw models auth login --provider openai”로 한 번 로그인하세요. Platform API 키가 필요하지 않습니다. 브라우저 Talk 전용입니다. 위임된 작업은 실행 중에 조정할 수 있으며 영향이 큰 작업에는 정확한 음성 확인이 필요합니다.",
      ready: "준비됨",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        ...
        gatewayOffline: "Gateway가 오프라인 상태여서 메모리 상태를 확인할 수 없습니다.",
      ...
      activity: {
        ...
        phaseHitCount: "단계 신호",
        lightPhaseHitCount: "얕은 수면 단계 히트",
  ...
  usage: {
    ...
    heatmap: {
      title: "토큰 활동",
      subtitle: "선택한 범위의 일별 토큰 강도이며, 최대 1년까지 표시됩니다.",
  ...
  cron: {
    adminRequired: "탐색 전용입니다. 자동화 변경에는 operator.admin 액세스 권한이 필요합니다.",
    tabs: {
      filterLabel: "자동화 상태",
      all: "전체",
      active: "활성",
