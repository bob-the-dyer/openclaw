...
export const tr: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ {date} tarihinde parlak görüldü",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Daha önceki aracı oturumlarından güvenilir anıları hazırlayın. Rüya görme, yararlı olanları uzun süreli belleğe yükseltir.",
      ...
      rollbackConfirmDescription:
        "Bu aracı için oturum geri doldurma tarafından oluşturulan günlük kayıtlarını ve hazırlanan anıları kaldırın.",
      rollbackWarning:
        "İzlenen oturum imleçleri yerinde kalır, bu nedenle kaldırılan kayıtlar yeniden hazırlanmayacaktır.",
      rollbackComplete: "Oturum geri doldurma geri alındı",
      rollbackCounts: "{diary} günlük kaydı ve {staged} hazırlanan kayıt kaldırıldı",
      unavailable: "Bu Gateway'de oturum geri doldurma kullanılamıyor.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      ...
      dockBottom: "Ask OpenClaw'u alta yerleştir",
      dockRight: "Ask OpenClaw'u sağa yerleştir",
    },
    history: {
      button: "Geçmiş",
  ...
  talkPage: {
    intro: "Gerçek zamanlı ses sağlayıcılarını, modelleri ve konuşmacı seslerini yapılandırın.",
    voiceSection: {
      title: "Gerçek zamanlı ses",
      description:
        "Aracınızla sürekli sesli konuşmalar. Aşağıdaki seçiciler talk.realtime ayarlarını yazar; daha aşağıdaki tam form diğer her şeyi kapsar.",
    },
    status: {
      title: "Durum",
      ready: "Hazır",
      ...
      noProvider: "Henüz gerçek zamanlı ses sağlayıcısı yapılandırılmadı.",
    },
    provider: {
      title: "Sağlayıcı",
    ...
    voice: {
      ...
      description:
        "Sözlü yanıtlar için kullanılan ses. GPT-Live, bir çağrı başladığında sesi kilitler.",
      default: "Sağlayıcı varsayılanı",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live bir ChatGPT aboneliğiyle çalışır: “openclaw models auth login --provider openai” ile bir kez oturum açın. Platform API anahtarı gerekmez. Yalnızca tarayıcı Talk. Devredilen işler çalışırken yönlendirilebilir ve yüksek etkili eylemler için tam sözlü onay gerektirir.",
      ready: "Hazır",
    },
  },
  memoryPage: {
    intro: "OpenClaw'ın aracı belleğini nasıl sakladığını, aradığını ve koruduğunu seçin.",
    ...
    overview: {
      hero: {
        ...
        needsAttention: "Bellek dikkat gerektiriyor",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "Bu aracının bellek motoru ve rüya döngüsü kontrol ediliyor.",
        offDescription: "Uyandırmak için Ayarlar'dan bir bellek motoru seçin.",
      ...
      activity: {
        title: "Etkinlik",
        promotedToday: "Bugün yükseltilen",
        promotedTotal: "Toplam yükseltilen",
        shortTermCount: "Bekleyen kısa vadeli girişler",
        phaseHitCount: "Faz sinyalleri",
        lightPhaseHitCount: "Hafif faz isabetleri",
        remPhaseHitCount: "REM faz isabetleri",
      },
      health: {
        title: "Motor sağlığı",
        provider: "Sağlayıcı",
        embeddings: "Gömmeler",
        runtime: "Gömme çalışma zamanı",
        healthy: "Hazır",
        unavailable: "Kullanılamıyor",
    ...
    memories: {
      ...
      searchPlaceholder: "Bu aracının anılarını ara",
      searchButton: "Ara",
      idle: "Bu aracının hatırladığı bir kişiyi, projeyi, kararı veya başka bir şeyi arayın.",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Seçili aralık için günlük token yoğunluğu, en fazla bir yıl.",
  ...
  cron: {
    adminRequired: "Yalnızca gözatma. Otomasyon değişiklikleri operator.admin erişimi gerektirir.",
    tabs: {
