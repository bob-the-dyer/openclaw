...
export const es: TranslationMap = {
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Prepara memorias de confianza de sesiones anteriores del agente. El proceso de sueño promueve las útiles a la memoria a largo plazo.",
      dateRange: "Rango de fechas de sesión",
      dateRangeHint:
        "Deja cualquiera de las fechas en blanco para escanear todo el rango disponible.",
      from: "Desde",
      to: "Hasta",
      actions: "Rellenar",
      ...
      previewTruncated:
        "Esta vista previa muestra el primer lote limitado. Aplicar continúa con los candidatos restantes.",
      candidateCount: "{count} candidatos",
      noCandidates: "No se encontraron nuevos candidatos de sesión de confianza.",
      progress: "Procesados {days} días · {staged} preparados",
      ...
      complete: "{count} preparados; la promoción ocurre mediante el sueño",
      rollbackConfirmTitle: "¿Revertir el relleno de sesiones?",
      rollbackConfirmDescription:
        "Eliminar las entradas del diario y los recuerdos preparados creados por el relleno de sesiones para este agente.",
      rollbackWarning:
        "Los cursores de sesión rastreados permanecen en su lugar, por lo que las entradas eliminadas no se prepararán de nuevo.",
      rollbackComplete: "Relleno de sesiones revertido",
      rollbackCounts: "{diary} entradas del diario y {staged} entradas preparadas eliminadas",
      unavailable: "El relleno de sesiones no está disponible en este Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  talkPage: {
    ...
    provider: {
      title: "Proveedor",
      description: "Auto elige el primer proveedor con credenciales que funcionen.",
      auto: "Automático",
    },
    model: {
      title: "Modelo",
      description: "Modelo de voz en tiempo real para las sesiones de Talk en el navegador.",
    ...
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live funciona con una suscripción a ChatGPT: inicia sesión una vez con “openclaw models auth login --provider openai”. No se necesita ninguna clave de la API de Platform. Solo Talk en el navegador. El trabajo delegado puede dirigirse mientras se ejecuta y requiere confirmación hablada exacta para acciones de alto impacto.",
      ready: "Listas",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        awake: "La memoria está despierta",
        waking: "Despertando la memoria…",
        ...
        offDescription: "Elige un motor de memoria en Ajustes para activarlo.",
        disabledDescription:
          "El motor de memoria seleccionado está deshabilitado. Vuelve a habilitarlo en Ajustes.",
        gatewayOffline:
          "El gateway está sin conexión, por lo que el estado de la memoria no está disponible.",
        hybridSearch: "búsqueda híbrida",
        keywordSearch: "búsqueda por palabras clave (sin incrustaciones)",
      ...
      activity: {
        ...
        promotedTotal: "Total promovidos",
    ...
    memories: {
      ...
      empty: "Ningún recuerdo coincidió con «{query}».",
      error: "La búsqueda de recuerdos falló: {message}",
      retry: "Reintentar",
      gatewayUpdateRequired: "Actualiza el gateway para buscar recuerdos desde el Control UI.",
      hybridSearch: "búsqueda híbrida",
