...
export const pl: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Shiny zauważono {date}",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Przygotuj zaufane wspomnienia z wcześniejszych sesji agenta. Śnienie promuje przydatne do pamięci długoterminowej.",
      ...
      noCandidates: "Nie znaleziono nowych zaufanych kandydatów sesji.",
      progress: "Przetworzono {days} dni · {staged} przygotowanych",
      processedCandidates: "Przetworzono {count} kandydatów sesji",
      processedDayCountOne: "Przetworzono {count} dzień",
      processedDayCount: "Przetworzono {count} dni",
      complete: "{count} przygotowanych; promocja następuje podczas śnienia",
      ...
      rollbackWarning:
        "Śledzone kursory sesji pozostają na miejscu, więc usunięte wpisy nie zostaną ponownie przygotowane.",
      rollbackComplete: "Uzupełnianie sesji zostało wycofane",
      rollbackCounts: "Usunięto {diary} wpisów dziennika i {staged} przygotowanych wpisów",
  ...
  mcpPage: {
    intro: "Połącz i zarządzaj serwerami MCP, które dostarczają narzędzia dla OpenClaw.",
  ...
  talkPage: {
    ...
    voiceSection: {
      ...
      description:
        "Ciągłe rozmowy głosowe z Twoim agentem. Selektory poniżej zapisują ustawienia talk.realtime; pełny formularz niżej obejmuje wszystko inne.",
    },
    status: {
      title: "Status",
      ready: "Gotowe",
      notReady: "Nieskonfigurowane",
      unavailable: "Niedostępne",
    ...
    provider: {
      title: "Dostawca",
      description: "Automatyczny wybiera pierwszego dostawcę z działającymi poświadczeniami.",
      auto: "Automatycznie",
    },
    model: {
      title: "Model",
      description: "Model głosu w czasie rzeczywistym dla sesji Talk w przeglądarce.",
    ...
    voice: {
      title: "Głos mówcy",
      description:
        "Głos używany do odpowiedzi mówionych. GPT-Live blokuje głos po rozpoczęciu połączenia.",
      default: "Domyślny dostawcy",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live działa z subskrypcją ChatGPT: zaloguj się raz za pomocą „openclaw models auth login --provider openai”. Nie jest potrzebny klucz Platform API. Tylko Talk w przeglądarce. Delegowaną pracą można sterować w trakcie jej wykonywania, a działania o dużym wpływie wymagają dokładnego potwierdzenia głosowego.",
      ready: "Gotowe",
    },
  },
  memoryPage: {
    intro: "Wybierz sposób, w jaki OpenClaw przechowuje, wyszukuje i utrzymuje pamięć agenta.",
    ...
    overview: {
      hero: {
        ...
        offDescription: "Wybierz silnik pamięci w Ustawieniach, aby go uruchomić.",
        disabledDescription:
      ...
      schedule: {
        ...
        nextRun: "następny {time}",
        lastRun: "ostatni {time}",
      ...
      activity: {
        ...
        shortTermCount: "Oczekujące wpisy krótkotrwałe",
    ...
    memories: {
      ...
      hybridSearch: "wyszukiwanie hybrydowe",
      keywordSearch: "wyszukiwanie po słowach kluczowych",
  ...
  usage: {
    ...
    heatmap: {
      ...
      subtitle: "Dzienne natężenie tokenów dla wybranego zakresu, do jednego roku.",
  ...
  chat: {
    ...
    composer: {
      ...
      fallbackActive: "Rezerwowy aktywny: {model}",
