...
export const de: TranslationMap = {
  ...
  quickSettings: {
    ...
    security: {
      intro:
        "Überprüfen Sie den Gateway-Zugriff, die Tool-Richtlinie, die Geräteauthentifizierung und Genehmigungen.",
      title: "Sicherheit",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Bereiten Sie vertrauenswürdige Erinnerungen aus früheren Agentensitzungen vor. Beim Träumen werden die nützlichen davon ins Langzeitgedächtnis übernommen.",
      dateRange: "Sitzungszeitraum",
      dateRangeHint:
      ...
      complete: "{count} vorgemerkt; die Übernahme erfolgt beim Träumen",
      rollbackConfirmTitle: "Sitzungs-Backfill zurücksetzen?",
      rollbackConfirmDescription:
        "Entfernt Tagebucheinträge und vorgemerkte Erinnerungen, die durch das Sitzungs-Backfill für diesen Agenten erstellt wurden.",
      rollbackWarning:
        "Verfolgte Sitzungscursor bleiben erhalten, sodass entfernte Einträge nicht erneut vorgemerkt werden.",
      rollbackComplete: "Sitzungs-Backfill zurückgesetzt",
      rollbackCounts: "{diary} Tagebucheinträge und {staged} vorgemerkte Einträge entfernt",
      unavailable: "Sitzungs-Backfill ist auf diesem Gateway nicht verfügbar.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  mcpPage: {
    ...
    setUpFirstServer: "Richten Sie Ihren ersten MCP-Server ein",
  ...
  talkPage: {
    ...
    voiceSection: {
      ...
      description:
        "Kontinuierliche Sprachunterhaltungen mit deinem Agenten. Die Auswahlfelder unten schreiben talk.realtime-Einstellungen; das vollständige Formular weiter unten deckt alles Übrige ab.",
    },
    status: {
      title: "Status",
      ready: "Bereit",
      ...
      unavailable: "Nicht verfügbar",
      unavailableHint:
        "Verbinde dich mit dem Gateway, um die Bereitschaft für Echtzeit-Sprache zu prüfen.",
    ...
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live funktioniert mit einem ChatGPT-Abo: Melde dich einmal mit „openclaw models auth login --provider openai“ an. Es ist kein Platform-API-Schlüssel nötig. Nur Browser-Talk. Delegierte Arbeit kann während der Ausführung gesteuert werden und erfordert für hochwirksame Aktionen eine exakte gesprochene Bestätigung.",
      ready: "Bereit",
    },
  },
  memoryPage: {
    intro: "Lege fest, wie OpenClaw den Speicher des Agenten ablegt, durchsucht und pflegt.",
    ...
    overview: {
      hero: {
        ...
        hibernating: "Speicher ist im Ruhezustand",
        ...
        offDescription:
          "Wählen Sie in den Einstellungen eine Speicher-Engine aus, um sie zu aktivieren.",
        disabledDescription:
          "Die ausgewählte Speicher-Engine ist deaktiviert. Aktivieren Sie sie erneut in den Einstellungen.",
    ...
    memories: {
      ...
      empty: "Keine Erinnerungen entsprachen „{query}“.",
