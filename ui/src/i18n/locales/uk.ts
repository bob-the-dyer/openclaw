...
export const uk: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Блискучого помічено {date}",
      lobsterdexCardCopyLink: "Копіювати посилання",
      lobsterdexOpen: "Відкрити Lobsterdex",
    },
    security: {
      intro:
        "Перегляньте доступ до gateway, політику інструментів, автентифікацію пристроїв та підтвердження.",
      title: "Безпека",
  ...
  memoryImport: {
    ...
    backfill: {
      title: "З минулих сесій",
      subtitle:
        "Підготуйте довірені спогади з попередніх сесій агента. Сновидіння переносить корисні з них у довготривалу пам’ять.",
      dateRange: "Діапазон дат сесій",
      dateRangeHint: "Залиште одну з дат порожньою, щоб сканувати весь доступний діапазон.",
      from: "Від",
      to: "До",
      actions: "Заповнення",
      ...
      previewTruncated:
        "Цей попередній перегляд показує перший обмежений пакет. Застосування продовжиться через решту кандидатів.",
      candidateCount: "{count} кандидатів",
      noCandidates: "Нових надійних кандидатів на сеанс не знайдено.",
      progress: "Оброблено днів: {days} · підготовлено: {staged}",
      processedCandidates: "Оброблено кандидатів на сеанс: {count}",
      processedDayCountOne: "Оброблено днів: {count}",
      processedDayCount: "Оброблено днів: {count}",
      complete: "Підготовлено: {count}; просування відбувається під час снів",
      rollbackConfirmTitle: "Відкотити заповнення сеансів?",
      rollbackConfirmDescription:
        "Видалити записи щоденника та підготовлені спогади, створені під час заповнення сеансів для цього агента.",
      rollbackWarning:
        "Відстежувані курсори сеансів залишаються на місці, тож видалені записи не будуть підготовлені знову.",
      rollbackComplete: "Заповнення сеансів відкочено",
      rollbackCounts: "Видалено записів щоденника: {diary} та підготовлених записів: {staged}",
      unavailable: "Заповнення сеансів недоступне на цьому Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  custodian: {
    ...
    panel: {
      ...
      dockRight: "Закріпити Ask OpenClaw праворуч",
    },
    history: {
      button: "Історія",
      title: "Останні зміни",
  ...
  mcpPage: {
    intro: "Підключайте та керуйте серверами MCP, що надають інструменти для OpenClaw.",
  ...
  talkPage: {
    ...
    voiceSection: {
      ...
      description:
        "Безперервні голосові розмови з вашим агентом. Селектори нижче записують налаштування talk.realtime; повна форма далі охоплює все інше.",
    },
    status: {
      title: "Статус",
      ready: "Готово",
      ...
      noProvider: "Провайдер голосу в реальному часі ще не налаштований.",
    },
    provider: {
      title: "Постачальник",
      description: "Автовибір бере перший провайдер із робочими обліковими даними.",
      auto: "Автоматично",
    },
    model: {
      title: "Модель",
      description: "Модель голосу в реальному часі для сеансів Talk у браузері.",
      default: "Стандартна для провайдера",
      defaultNamed: "Стандартна ({model})",
    },
    voice: {
      title: "Голос диктора",
      description:
        "Голос, що використовується для озвучених відповідей. GPT-Live фіксує голос після початку дзвінка.",
      default: "Стандартна для провайдера",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live працює з підпискою ChatGPT: увійдіть один раз командою “openclaw models auth login --provider openai”. Ключ Platform API не потрібен. Лише Talk у браузері. Делегованою роботою можна керувати під час виконання, а дії з високим впливом потребують точного голосового підтвердження.",
      ready: "Готово",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        ...
        loadingDescription: "Перевірка рушія пам'яті та циклу сну цього агента.",
        offDescription: "Виберіть рушій пам'яті в Налаштуваннях, щоб активувати його.",
        disabledDescription:
          "Вибраний рушій пам'яті вимкнено. Увімкніть його знову в Налаштуваннях.",
        gatewayOffline: "Gateway offline, тому статус пам'яті недоступний.",
      ...
      activity: {
        title: "Активність",
        promotedToday: "Підвищено сьогодні",
        promotedTotal: "Підвищено всього",
        shortTermCount: "Очікувані короткострокові записи",
        phaseHitCount: "Сигнали фаз",
        lightPhaseHitCount: "Спрацювання легкої фази",
        remPhaseHitCount: "Спрацювання фази REM",
      },
      health: {
        title: "Стан рушія",
        provider: "Постачальник",
        embeddings: "Embeddings",
        runtime: "Середовище виконання ембедингів",
        healthy: "Готово",
        unavailable: "Недоступно",
      ...
      shortcuts: {
        title: "Огляд памʼяті",
        memories: "Пошук у памʼяті",
        diary: "Читати щоденник снів",
        settings: "Налаштувати памʼять",
      },
    },
    memories: {
      searchLabel: "Пошук у памʼяті",
      searchPlaceholder: "Шукати в памʼяті цього агента",
      searchButton: "Пошук",
      idle: "Шукайте людину, проєкт, рішення чи будь-що інше, що памʼятає цей агент.",
      searching: "Пошук у памʼяті…",
      results: "{count} результатів",
      empty: "Немає збігів у памʼяті для «{query}».",
      error: "Пошук у памʼяті не вдався: {message}",
      retry: "Повторити",
      gatewayUpdateRequired: "Оновіть gateway, щоб шукати в памʼяті з Control UI.",
      hybridSearch: "гібридний пошук",
      keywordSearch: "пошук за ключовими словами",
      lineRange: "рядки {start}–{end}",
      score: "оцінка {score}",
      sourceMemory: "памʼять",
      sourceSessions: "сеанси",
      fileLoading: "Завантаження повного файлу памʼяті…",
      fileError: "Не вдалося завантажити цей файл памʼяті: {message}",
      fileUnsupported: "Цей файл памʼяті не можна показати як текст.",
    },
    engine: {
      title: "Рушій",
      description:
  ...
  chat: {
    ...
    sidebar: {
      ...
      groups: "Групи",
      coding: "Програмування",
      noSessionsForAgent: "Для цього агента не знайдено сесій",
    ...
    composer: {
      ...
      compactingContext: "Ущільнення контексту...",
      contextCompacted: "Контекст ущільнено",
  ...
  cron: {
    adminRequired: "Лише перегляд. Зміна автоматизації потребує доступу operator.admin.",
    tabs: {
