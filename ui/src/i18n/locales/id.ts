...
export const id: TranslationMap = {
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      applying: "Menerapkan…",
      rollback: "Rollback",
      previewSummary: "{candidates} kandidat sepanjang {days} hari",
      previewTruncated:
        "Pratinjau ini menampilkan batch terbatas pertama. Apply melanjutkan ke kandidat yang tersisa.",
      ...
      rollbackConfirmTitle: "Batalkan backfill sesi?",
      rollbackConfirmDescription:
        "Hapus entri diary dan memori yang disiapkan yang dibuat oleh backfill sesi untuk agen ini.",
      rollbackWarning:
        "Kursor sesi yang dilacak tetap di tempatnya, jadi entri yang dihapus tidak akan disiapkan lagi.",
      rollbackComplete: "Backfill sesi dibatalkan",
      rollbackCounts: "{diary} entri diary dan {staged} entri yang disiapkan dihapus",
  ...
  talkPage: {
    intro: "Konfigurasi penyedia suara realtime, model, dan suara pembicara.",
    voiceSection: {
      title: "Suara realtime",
      description:
        "Percakapan suara berkelanjutan dengan agen Anda. Pemilih di bawah menulis pengaturan talk.realtime; formulir lengkap di bawahnya mencakup semua hal lainnya.",
    },
    status: {
      title: "Status",
      ready: "Siap",
      ...
      unavailable: "Tidak tersedia",
      unavailableHint: "Sambungkan ke Gateway untuk memeriksa kesiapan suara realtime.",
    ...
    model: {
      title: "Model",
      description: "Model suara realtime untuk sesi Talk browser.",
    ...
    voice: {
      ...
      description:
        "Suara yang digunakan untuk balasan lisan. GPT-Live mengunci suara begitu panggilan dimulai.",
      default: "Default penyedia",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live bekerja dengan langganan ChatGPT: masuk sekali dengan “openclaw models auth login --provider openai”. Tidak perlu kunci Platform API. Hanya Talk browser. Pekerjaan yang didelegasikan dapat diarahkan saat berjalan dan memerlukan konfirmasi lisan yang tepat untuk tindakan berdampak tinggi.",
      ready: "Siap",
    },
  },
  memoryPage: {
    ...
    overview: {
      hero: {
        ...
        needsAttention: "Memori perlu perhatian",
        activeDescription: "{engine} · {mode}",
        loadingDescription: "Memeriksa mesin memori dan siklus mimpi agen ini.",
        offDescription: "Pilih mesin memori di Pengaturan untuk membangunkannya.",
        disabledDescription:
      ...
      shortcuts: {
        ...
        diary: "Baca dream diary",
        settings: "Konfigurasi memori",
      },
    },
    memories: {
  ...
  chat: {
    ...
    sidebar: {
      ...
      groups: "Grup",
      coding: "Coding",
      noSessionsForAgent: "Tidak ada sesi yang ditemukan untuk agen ini",
    ...
    messages: {
      ...
      selectionActions: "Tindakan pemilihan",
  ...
  cron: {
    adminRequired: "Hanya menjelajah. Perubahan otomatisasi memerlukan akses operator.admin.",
    tabs: {
