...
export const pt_BR: TranslationMap = {
  ...
  quickSettings: {
    ...
    appearance: {
      ...
      lobsterdexCardShinySeen: "✦ Shiny avistado em {date}",
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Prepare memórias confiáveis de sessões anteriores do agente. O sonhar promove as úteis para a memória de longo prazo.",
      dateRange: "Intervalo de datas da sessão",
      dateRangeHint:
        "Deixe qualquer uma das datas em branco para varrer todo o intervalo disponível.",
      from: "De",
      to: "Até",
      actions: "Preenchimento",
      preview: "Visualizar",
      ...
      rollbackConfirmDescription:
        "Remove entradas de diário e memórias preparadas criadas pelo preenchimento de sessão para este agente.",
      rollbackWarning:
      ...
      unavailable: "O preenchimento de sessão está indisponível neste Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  talkPage: {
    intro: "Configure provedores de voz em tempo real, modelos e vozes de locutores.",
    voiceSection: {
      title: "Voz em tempo real",
      description:
        "Conversas contínuas por voz com seu agente. Os seletores abaixo gravam as configurações de talk.realtime; o formulário completo mais adiante abrange todo o resto.",
    },
    status: {
      title: "Status",
      ready: "Pronto",
    ...
    provider: {
      title: "Provedor",
      description: "Auto escolhe o primeiro provedor com credenciais funcionais.",
      auto: "Automático",
    },
    model: {
      title: "Modelo",
      description: "Modelo de voz em tempo real para sessões de Talk no navegador.",
    ...
    voice: {
      ...
      description:
        "Voz usada para respostas faladas. O GPT-Live bloqueia a voz assim que uma chamada começa.",
      default: "Padrão do provedor",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "O GPT-Live funciona com uma assinatura do ChatGPT: entre uma vez com “openclaw models auth login --provider openai”. Não é necessária uma chave da Platform API. Apenas Talk no navegador. O trabalho delegado pode ser orientado durante a execução e exige confirmação falada exata para ações de alto impacto.",
      ready: "Pronto",
    },
  },
  memoryPage: {
    ...
    overview: {
      ...
      activity: {
        ...
        lightPhaseHitCount: "Acertos de fase leve",
        remPhaseHitCount: "Acertos de fase REM",
      },
      health: {
        title: "Integridade do mecanismo",
        provider: "Provedor",
        embeddings: "Embeddings",
        runtime: "Runtime de embedding",
        healthy: "Pronto",
        unavailable: "Indisponível",
    ...
    memories: {
      ...
      error: "Falha na busca de memórias: {message}",
      retry: "Tentar novamente",
      gatewayUpdateRequired: "Atualize o gateway para buscar memórias a partir da Control UI.",
      hybridSearch: "busca híbrida",
