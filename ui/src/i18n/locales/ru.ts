...
export const ru: TranslationMap = {
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Подготовьте доверенные воспоминания из предыдущих сессий агента. Dreaming переносит полезные из них в долговременную память.",
      dateRange: "Диапазон дат сессий",
      dateRangeHint: "Оставьте одну из дат пустой, чтобы просканировать весь доступный диапазон.",
      from: "С",
      to: "Кому",
      ...
      previewTruncated:
        "В этом предпросмотре показан первый ограниченный пакет. Применение продолжится по оставшимся кандидатам.",
      candidateCount: "{count} кандидатов",
      noCandidates: "Новые доверенные кандидаты сессий не найдены.",
      progress: "Обработано {days} дней · подготовлено {staged}",
      processedCandidates: "Обработано кандидатов сессий: {count}",
      processedDayCountOne: "Обработан {count} день",
      processedDayCount: "Обработано дней: {count}",
      complete: "Подготовлено: {count}; продвижение происходит через сновидение",
      rollbackConfirmTitle: "Откатить дозаполнение сессий?",
      rollbackConfirmDescription:
        "Удалить записи дневника и подготовленные воспоминания, созданные дозаполнением сессий для этого агента.",
      rollbackWarning:
        "Отслеживаемые курсоры сессий остаются на месте, поэтому удалённые записи не будут подготовлены снова.",
      rollbackComplete: "Дозаполнение сессий откачено",
      rollbackCounts: "Удалено записей дневника: {diary} и подготовленных записей: {staged}",
      unavailable: "Дозаполнение сессий недоступно на этом Gateway.",
    },
  },
  onboarding: {
    memoryImport: {
  ...
  talkPage: {
    ...
    provider: {
      title: "Поставщик",
      description: "«Авто» выбирает первого провайдера с рабочими учётными данными.",
      auto: "Авто",
    },
    model: {
      title: "Модель",
      description: "Модель голоса в реальном времени для сеансов Talk в браузере.",
    ...
    voice: {
      title: "Голос диктора",
      description:
        "Голос, используемый для устных ответов. GPT-Live фиксирует голос после начала вызова.",
      default: "По умолчанию для провайдера",
    },
    gptLive: {
      title: "GPT-Live",
      hint: "GPT-Live работает с подпиской ChatGPT: войдите один раз с помощью «openclaw models auth login --provider openai». Ключ Platform API не требуется. Только Talk в браузере. Делегированной работой можно управлять во время выполнения, а для действий с большим влиянием требуется точное устное подтверждение.",
      ready: "Готово",
    },
  },
  memoryPage: {
    intro: "Выберите, как OpenClaw хранит, ищет и поддерживает память агента.",
    ...
    overview: {
      hero: {
        ...
        loadingDescription: "Проверка движка памяти и цикла сновидений этого агента.",
        offDescription: "Выберите движок памяти в настройках, чтобы пробудить её.",
      ...
      activity: {
        title: "Активность",
        promotedToday: "Повышено сегодня",
        promotedTotal: "Повышено всего",
        shortTermCount: "Ожидающие краткосрочные записи",
        phaseHitCount: "Сигналы фаз",
        lightPhaseHitCount: "Попадания в лёгкой фазе",
        remPhaseHitCount: "Попадания в фазе REM",
      },
      health: {
      ...
      shortcuts: {
        title: "Обзор памяти",
        memories: "Поиск в памяти",
        diary: "Читать дневник снов",
        settings: "Настроить память",
      },
    },
    memories: {
      searchLabel: "Поиск в памяти",
      searchPlaceholder: "Искать в памяти этого агента",
      searchButton: "Поиск",
      idle: "Найдите человека, проект, решение или что-либо ещё, что помнит этот агент.",
      searching: "Поиск в памяти…",
      results: "{count} результатов",
      empty: "Ничего не найдено по запросу «{query}».",
      error: "Ошибка поиска в памяти: {message}",
      retry: "Повторить",
      gatewayUpdateRequired: "Обновите gateway, чтобы искать в памяти из Control UI.",
      hybridSearch: "гибридный поиск",
  ...
  profilePage: {
    ...
    usageStatisticsDescription: "Просмотр активности, расходов и трендов использования.",
    identity: {
      title: "Профиль",
  ...
  chat: {
    ...
    sidebar: {
      ...
      groups: "Группы",
      coding: "Программирование",
      noSessionsForAgent: "Сессии для этого агента не найдены",
    ...
    composer: {
      ...
      fallbackActive: "Резервный вариант активен: {model}",
