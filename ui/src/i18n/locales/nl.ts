...
export const nl: TranslationMap = {
  ...
  memoryImport: {
    ...
    backfill: {
      ...
      subtitle:
        "Zet vertrouwde herinneringen klaar uit eerdere agentsessies. Tijdens het dromen worden de nuttige gepromoveerd naar het langetermijngeheugen.",
      ...
      previewTruncated:
        "Dit voorbeeld toont de eerste begrensde batch. Toepassen gaat verder met de overige kandidaten.",
      candidateCount: "{count} kandidaten",
      noCandidates: "Er zijn geen nieuwe vertrouwde sessiekandidaten gevonden.",
      progress: "{days} dagen verwerkt · {staged} in wachtrij",
      ...
      complete: "{count} in wachtrij; promotie gebeurt via dreaming",
      rollbackConfirmTitle: "Sessie-backfill terugdraaien?",
      rollbackConfirmDescription:
        "Verwijder dagboekvermeldingen en gestagede herinneringen die door sessie-backfill voor deze agent zijn aangemaakt.",
      rollbackWarning:
        "Gevolgde sessiecursors blijven behouden, dus verwijderde vermeldingen worden niet opnieuw in de wachtrij geplaatst.",
      rollbackComplete: "Sessie-backfill teruggedraaid",
      rollbackCounts: "{diary} dagboekvermeldingen en {staged} gestagede vermeldingen verwijderd",
  ...
  talkPage: {
    intro: "Configureer realtime spraakproviders, modellen en sprekerstemmen.",
    voiceSection: {
      title: "Realtime spraak",
      description:
        "Doorlopende spraakgesprekken met je agent. De keuzemenu's hieronder schrijven talk.realtime-instellingen; het volledige formulier verderop dekt al het andere.",
    },
    status: {
      title: "Status",
      ready: "Gereed",
  ...
  memoryPage: {
    ...
    overview: {
      hero: {
        ...
        offDescription: "Kies een geheugen-engine in Instellingen om deze te activeren.",
        disabledDescription:
          "De geselecteerde geheugen-engine is uitgeschakeld. Schakel deze opnieuw in via Instellingen.",
      ...
      activity: {
        ...
        shortTermCount: "Kortetermijnitems in afwachting",
        phaseHitCount: "Fasesignalen",
        lightPhaseHitCount: "Lichte-fasetreffers",
        remPhaseHitCount: "REM-fasetreffers",
      },
      health: {
        title: "Engine-status",
        provider: "Provider",
    ...
    memories: {
      ...
      fileError: "Kan dit geheugenbestand niet laden: {message}",
